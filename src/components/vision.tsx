...
export function Vision(): JSX.Element {
  return (
    <section className="px-4 py-8 md:p-20 flex flex-col gap-8 md:gap-16">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="vision">
            <div className="flex flex-col gap-4 md:gap-6">
              <p className="font-bold text-xl md:text-2xl">XRP Ledger Origin</p>
            ...
            <AccordionContent className="flex flex-col  gap-4 md:gap-6">
              ...
              <p className="font-bold  text-xl md:text-2xl">XLS-20 Launch</p>
              <p className="text-sm md:text-xl">
              ...
              <p className="font-bold  text-xl md:text-2xl">Decade of Innovation and Security</p>
              <p className="text-sm md:text-xl">
              ...
              <p className="font-bold  text-xl md:text-2xl">Embracing a Multi-Chain Future</p>
              <p className="text-sm md:text-xl">
            ...
            <AccordionTrigger className="pt-4 md:pt-8 group text-sm md:text-xl">
