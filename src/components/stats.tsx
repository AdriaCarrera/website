    ...
    <section className="relative h-[588px] md:h-auto md:aspect-[2/1] overflow-hidden">
      ...
      <div className="absolute inset-0 grid-overlay">
        <div className="grid grid-cols-[repeat(4,1fr)_0.2fr] grid-rows-[repeat(5,1fr)_0.66fr] md:grid-cols-16 md:grid-rows-8 h-full w-full">
          ...
          <div
            className="ml-4 my-2 md:mt-0 md:ml-0 md:my-0 h-[95px] md:h-auto col-span-4 col-start-1 row-start-2 md:col-start-2 md:row-start-4 md:col-span-4 md:row-span-2 flex flex-col items-center justify-center md:gap-6 border-[0.5px] border-white bg-cover"
            style={{
          ...
          <div
            className="ml-4 my-2 md:mt-0 md:ml-0 md:my-0 h-[95px] md:h-auto col-span-4 col-start-1 row-start-3 md:col-start-7 md:row-start-4 md:col-span-4 md:row-span-2 flex flex-col items-center justify-center md:gap-6 border-[0.5px] border-white bg-cover"
            style={{
          ...
          <div
            className="ml-4 my-2 md:mt-0 md:ml-0 md:my-0 h-[95px] md:h-auto col-span-4 col-start-1 row-start-4 md:col-start-12 md:row-start-4 md:col-span-4 md:row-span-2 flex flex-col items-center justify-center md:gap-6 border-[0.5px] border-white bg-cover"
            style={{
          ...
          <div
            className="ml-4 my-2 md:mt-0 md:ml-0 md:my-0 h-[95px] md:h-auto col-span-4 col-start-1 row-start-5 md:col-start-2 md:row-start-7 md:col-span-4 md:row-span-2 flex flex-col items-center justify-center md:gap-6 border-[0.5px] border-white bg-cover"
            style={{
